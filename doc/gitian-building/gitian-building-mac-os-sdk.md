...
The script [extract-osx-sdk.sh](https://github.com/vip-project/vip/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
vip/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/vip-project/vip/blob/master/doc/README_osx.md) for troubleshooting tips.