...
This document provides guidelines for internationalization of the VIP Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to VIP network</numerusform>
            <numerusform>%n active connections to VIP network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `vip_en.ts` remains unchanged.
