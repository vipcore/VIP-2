UNIX BUILD NOTES
====================
Some notes on how to build VIP Core in Unix.

Note
---------------------
Always use absolute paths to configure and compile VIP Core and the dependencies,
...
memory available when compiling VIP Core. On systems with less, gcc can be
 ...
 **For Ubuntu only:** db4.8 packages are available [here](https://launchpad.net/~vip/+archive/vip).
 You can add the repository using the following command:

    sudo apt-get install software-properties-common
    sudo add-apt-repository ppa:vip/vip
    sudo apt-get update
...
To build VIP Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Security
--------
To help make your VIP Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, VIP Core should be built with a non-executable stack
