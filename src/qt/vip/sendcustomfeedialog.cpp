...
#include "qt/vip/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(VIPGUI* parent, WalletModel* model) :
    QDialog(parent),
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &VIPGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
