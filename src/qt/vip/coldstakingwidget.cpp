...
#include "qt/vip/coldstakingwidget.h"
#include "qt/vip/forms/ui_coldstakingwidget.h"
#include "qt/vip/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/vip/requestdialog.h"
#include "qt/vip/tooltipmenu.h"
#include "qt/vip/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(VIPGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your VIPs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept VIP delegation / Delegate VIP"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select VIP outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 VIP" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
