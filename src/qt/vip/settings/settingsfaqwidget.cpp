...
#include "qt/vip/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/vip/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(VIPGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    // Web Link
    ui->pushButtonWebLink->setText("https://VIP.org/");
    ...
    if (parent)
        connect(parent, &VIPGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
