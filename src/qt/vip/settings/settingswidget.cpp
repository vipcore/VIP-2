...
#include "qt/vip/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(VIPGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &VIPGUI::openFAQ);
