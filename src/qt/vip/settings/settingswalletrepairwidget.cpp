...
#include "qt/vip/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/vip/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(VIPGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to VIPGUI::handleRestart()
