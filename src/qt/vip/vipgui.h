...
#ifndef VIP_CORE_NEW_GUI_VIPGUI_H
#define VIP_CORE_NEW_GUI_VIPGUI_H
...
#include "qt/vip/navmenuwidget.h"
#include "qt/vip/topbar.h"
#include "qt/vip/dashboardwidget.h"
#include "qt/vip/send.h"
#include "qt/vip/receivewidget.h"
#include "qt/vip/addresseswidget.h"
#include "qt/vip/privacywidget.h"
#include "qt/vip/coldstakingwidget.h"
#include "qt/vip/masternodeswidget.h"
#include "qt/vip/snackbar.h"
#include "qt/vip/settings/settingswidget.h"
...
/**
  VIP GUI main class. This class represents the main window of the VIP UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class VIPGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit VIPGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~VIPGUI();
...
#endif //VIP_CORE_NEW_GUI_VIPGUI_H
