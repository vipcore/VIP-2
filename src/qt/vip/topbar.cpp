...
#include "qt/vip/forms/ui_topbar.h"
#include "qt/vip/lockunlock.h"
#include "qt/vip/qtutils.h"
#include "qt/vip/receivedialog.h"
#include "qt/vip/loadingdialog.h"
...
TopBar::TopBar(VIPGUI* _mainWindow, QWidget *parent) :
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // VIP Total
    CAmount vipAvailableBalance = balance;
    // zVIP Balance
    CAmount matureZerocoinBalance = zerocoinBalance - unconfirmedZerocoinBalance - immatureZerocoinBalance;

    // Set
    QString totalPiv = GUIUtil::formatBalance(vipAvailableBalance, nDisplayUnit);
    ...
    // Update display state and/or values for zVIP balances as necessary
    bool fHaveZerocoins = zerocoinBalance > 0;

    // Set visibility of zVIP label titles/values
