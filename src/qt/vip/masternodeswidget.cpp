...
#include "qt/vip/forms/ui_masternodeswidget.h"

#include "qt/vip/qtutils.h"
#include "qt/vip/mnrow.h"
#include "qt/vip/mninfodialog.h"
#include "qt/vip/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(VIPGUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:28188 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= (COIN * 10000)) {
        inform(tr("Not enough balance to create a masternode, 10,000 VIP required."));
        return;
    }
    showHideOp(true);
