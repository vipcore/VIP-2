...
#include "qt/vip/furabstractlistitemdelegate.h"
#include "qt/vip/txviewholder.h"
#include "qt/vip/tooltipmenu.h"
#include "qt/vip/sendmultirow.h"
#include "qt/vip/coldstakingmodel.h"
#include "qt/vip/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(VIPGUI* parent);
    ~ColdStakingWidget();
