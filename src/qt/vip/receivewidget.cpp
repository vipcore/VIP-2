...
#include "qt/vip/forms/ui_receivewidget.h"
...
#include "qt/vip/addressholder.h"
...
ReceiveWidget::ReceiveWidget(VIPGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive VIP."));
