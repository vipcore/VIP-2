...
QString BitcoinUnits::name(int unit, bool isZvip)
{
    QString z = "";
    if(isZvip) z = "z";
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case VIP:
            return z + QString("VIP");
        case mVIP:
            return z + QString("mVIP");
        case uVIP:
            return z + QString::fromUtf8("μVIP");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case VIP:
            return z + QString("tVIP");
        case mVIP:
            return z + QString("mtVIP");
        case uVIP:
            return z + QString::fromUtf8("μtVIP");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZVIP)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZVIP);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZVIP)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZVIP));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
