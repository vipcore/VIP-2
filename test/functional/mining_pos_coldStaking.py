...
from test_framework.vip_node import PivxTestNode
...
class VIP_ColdStakingTest(PivxTestFramework):
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 VIP from the pot)
