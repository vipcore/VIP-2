...
"""Verify that starting vip with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vip with -h for help text")
        ...
        self.log.info("Start vip with -version for version information")
